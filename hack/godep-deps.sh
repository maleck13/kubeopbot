...
mkdir -p ${goPath}/src/github.com/maleck13/kubeop-bot
cp -R . ${goPath}/src/github.com/maleck13/kubeop-bot

pushd ${goPath}/src/github.com/maleck13/kubeop-bot
rm -rf vendor || true
...
mv ${goPath}/src/github.com/maleck13/kubeop-bot/vendor .
mv ${goPath}/src/github.com/maleck13/kubeop-bot/Godeps .
git add vendor
git add Godeps
