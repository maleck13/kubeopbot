...
# 3. rewrite the history on that branch to *only* include staging/src/github.com/maleck13/kubeop-bot
...
# this command rewrite git history to *only* include staging/src/github.com/maleck13/kubeop-bot
git filter-branch -f --subdirectory-filter staging/src/github.com/maleck13/kubeop-bot HEAD
