...
import (
	...
	kubeopbotregistry "github.com/maleck13/kubeop-bot/pkg/registry"
	alertstorage "github.com/maleck13/kubeop-bot/pkg/registry/kubeopbot/alert"
)
...
func (c completedConfig) New() (*WardleServer, error) {
	...
	apiGroupInfo := genericapiserver.NewDefaultAPIGroupInfo(kubeopbot.GroupName, registry, Scheme, metav1.ParameterCodec, Codecs)
	apiGroupInfo.GroupMeta.GroupVersion = v1alpha1.SchemeGroupVersion
	v1alpha1storage := map[string]rest.Storage{}
	v1alpha1storage["alerts"] = kubeopbotregistry.RESTInPeace(alertstorage.NewREST(Scheme, c.GenericConfig.RESTOptionsGetter))
