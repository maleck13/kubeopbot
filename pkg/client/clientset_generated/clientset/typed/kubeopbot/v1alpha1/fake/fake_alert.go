...
type FakeAlerts struct {
	Fake *FakeKubeopbotV1alpha1
	ns   string
}

var alertsResource = schema.GroupVersionResource{Group: "kubeopbot.k8s.io", Version: "v1alpha1", Resource: "alerts"}

var alertsKind = schema.GroupVersionKind{Group: "kubeopbot.k8s.io", Version: "v1alpha1", Kind: "Alert"}
