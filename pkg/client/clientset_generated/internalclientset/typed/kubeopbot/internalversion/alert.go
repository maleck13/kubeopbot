...
import (
	...
	scheme "github.com/maleck13/kubeop-bot/pkg/client/clientset_generated/internalclientset/scheme"
...
type AlertInterface interface {
	Create(*kubeopbot.Alert) (*kubeopbot.Alert, error)
	Update(*kubeopbot.Alert) (*kubeopbot.Alert, error)
	UpdateStatus(*kubeopbot.Alert) (*kubeopbot.Alert, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*kubeopbot.Alert, error)
	List(opts v1.ListOptions) (*kubeopbot.AlertList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubeopbot.Alert, err error)
	AlertExpansion
}
...
func newAlerts(c *KubeopbotClient, namespace string) *alerts {
	return &alerts{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *alerts) Get(name string, options v1.GetOptions) (result *kubeopbot.Alert, err error) {
	result = &kubeopbot.Alert{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
		Name(name).
...
func (c *alerts) List(opts v1.ListOptions) (result *kubeopbot.AlertList, err error) {
	result = &kubeopbot.AlertList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Create(alert *kubeopbot.Alert) (result *kubeopbot.Alert, err error) {
	result = &kubeopbot.Alert{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Update(alert *kubeopbot.Alert) (result *kubeopbot.Alert, err error) {
	result = &kubeopbot.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) UpdateStatus(alert *kubeopbot.Alert) (result *kubeopbot.Alert, err error) {
	result = &kubeopbot.Alert{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("alerts").
...
func (c *alerts) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *kubeopbot.Alert, err error) {
	result = &kubeopbot.Alert{}
