...
import (
	...
	"github.com/maleck13/kubeop-bot/pkg/client/clientset_generated/internalclientset/fake"
...
func TestWantsInternalWardleInformerFactory(t *testing.T) {
	...
	target, err := alertinitializer.New(sf)
	if err != nil {
...
var _ alertinitializer.WantsInternalWardleInformerFactory = &wantInternalWardleInformerFactory{}
